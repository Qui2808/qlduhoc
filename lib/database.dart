...
class DBHelper {
  ...
  //     data.add(User(id: int.parse(item['ID'].toString()), UserName: item['UserName'].toString(), Password: item['Password'].toString()));
  //
  //   }
  //   db.close();
  //   return data;
  ...
  //   db.insert('tbluser', user.toMap(), conflictAlgorithm: ConflictAlgorithm.ignore);
  //   db.close();
  //   return true;
  // }
